...
<div class="mdc-layout-grid">
    ...
    <div class="mdc-layout-grid__inner">
        ...
        <div class="mdc-card">
            <h6 class="card-title">Create Task for {{ $project->project_name }}</h6>
            <div class="template-demo">
            <div class="mdc-layout-grid__inner">
                <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12-desktop">
                <div class="mdc-text-field mdc-text-field--outlined">
                    <input class="mdc-text-field__input" id="task_name">
...
@endsection
@section('script')
<script src="{{ asset('resources/views/task/js/create.js') }}"></script>
@endsection