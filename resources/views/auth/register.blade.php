...
<script src="{{ asset('public/assets/js/preloader.js') }}"></script>
                  ...
                  <form id="user_form">
                    <div class="mdc-layout-grid">
                      <div class="mdc-layout-grid__inner">
                        ...
                        <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6 first_name_form_error d-none">
                        <div class="invalid-feedback first_name_form_error d-none" role="alert"><strong></strong></div>   		 
                        </div>
                        <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6 last_name_form_error d-none">
                        ...
                        <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
                          <div class="mdc-text-field w-100">
                          <input class="mdc-text-field__input" type="password" id="password_confirmation">
                            <div class="mdc-line-ripple"></div>
                        ...
                        <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
                          <a href="javascript:void(0);" id="submit" class="mdc-button mdc-button--raised w-100">
                            Register
                          </a>
                        </div>
  ...
  <script src="{{ asset('public/assets/vendors/js/vendor.bundle.base.js') }}"></script>
    ...
    <script src="{{ asset('resources/views/auth/js/register.js') }}"></script>
